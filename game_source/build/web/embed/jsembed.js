...
var jsembed = function()
{
    ...
    var widthIdeal 	= 1280; // Default only, value set at runtime via jsembed.embed -- represents the "native" dimensions of the embeded JS app
    var heightIdeal = 720; // Default only, value set at runtime via jsembed.embed -- represents the "native" dimensions of the embeded JS app
    var scaleMax = 3; // The largest ratio we let the app scale to. 3 represents 300%.
    var widthMax = 1280; // The maximum canvas width we'll allow. Only applies to FILL_TO
    var heightMax = 720; // The maximum canvas height we'll allow. Only applies to FILL_TO
