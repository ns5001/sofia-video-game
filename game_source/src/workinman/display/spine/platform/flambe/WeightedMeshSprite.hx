...
class WeightedMeshSprite extends Sprite {

    /** The mesh attachment for this sprite */
    public var meshAttachment (default, null)	: WeightedMeshAttachment;
    ...
    public function new (meshAttachment :WeightedMeshAttachment, slot:Slot)
    {
    ...
    private override function _draw (g :Graphics) {
		...
		while(i < triangles.length)
		{
			...
			g.canvasCtx.save();
			#if debug
				g.canvasCtx.strokeStyle="#FF0000";
			#end
